...
public class MainCliente extends javax.swing.JPanel {
    ...
    public void listarClientes() {
        ...
        if (listarCleintes != null) {
            ...
            for (int i = 0; i < listarCleintes.size(); i++) {
                ...
                ob[3] = listarCleintes.get(i).getDocumentos();
                modelo.addRow(ob);
            }
        }
    ...
    private void paintForm() {
        if (jTable1.getSelectedRow() != -1) {
            ...
            txtNombres.setText(d.getNombrers());
            cbxTipo.setSelectedItem(d.getDocumentos());
...
<<<<<<< HEAD
        jLabel7 = new javax.swing.JLabel();
=======
>>>>>>> 80f5904d48c193e293968cb14f51533d4510f81a
>>>>>>> 657518057f6e9dc98474e60e8238e8f4abd037b5
...
<<<<<<< HEAD
        ...
        jLabel7.setText("HEINER APAZA APAZA");
...
>>>>>>> 657518057f6e9dc98474e60e8238e8f4abd037b5
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        to.setDocumentos(cbxTipo.getSelectedItem() == null ? ""
                : cbxTipo.getSelectedItem().toString());
        int fila = jTable1.getSelectedRow();
        if (fila != -1) {
            try {
                Cliente resultado = clienteService.actualizarEbtidad(to);
                if (resultado != null) {
                    modelo = (DefaultTableModel) jTable1.getModel();
                ...
                if (JOptionPane.showConfirmDialog(this, "Esta seguro de crear un nuevo cliente?", "Mensaje de confirmación", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE) == 0) {
                    if (clienteService.guardarEntidad(to) != null) {
                        ...
                        Object nuevo[] = {modelo.getRowCount() + 1, to.getDniruc(),
                            to.getNombrers(), to.getDocumentos()};
                        modelo.addRow(nuevo);
                        resetForm();
